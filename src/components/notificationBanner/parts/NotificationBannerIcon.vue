...
<template>
  <template v-if="type === 'info1' || type === 'info2'">
    <svg aria-label="情報提示" fill="none" height="36" role="img" viewBox="0 0 36 36" width="36">
  ...
  <template v-else-if="type === 'warning'">
    <svg aria-label="警告" fill="none" height="36" role="img" viewBox="0 0 36 36" width="36">
  ...
  <template v-else-if="type === 'error'">
    <svg aria-label="エラー" fill="none" height="36" role="img" viewBox="0 0 36 36" width="36">
      <g>
        <path
  ...
  <template v-else-if="type === 'success'">
    <svg aria-label="成功" fill="none" height="36" role="img" viewBox="0 0 36 36" width="36">
      <g>
